...
function pe(e, t) {
  ...
  let p = e.headers.get("Accept") ?? "", _ = t?.formats?.find((b) => p.includes(b))?.replace("image/", "");
...
function xe() {
  ...
  globalThis.fetch = async (...t) => {
    ...
    return s || (s = await J(r), s) ? s : (be(r), e(r));
  };
}
__name(xe, "xe");
async function we(e) {
...
var M = class {
  ...
  applyRouteDest(t, r, s) {
    ...
    return x(this.searchParams, b.searchParams), P(this.path) || (this.path = b.pathname), a;
  }
...
var Ss = { async fetch(e, t, r) {
  ...
  return a.run({ ...t, NODE_ENV: "production", SUSPENSE_CACHE_URL: R }, async () => i.run({ env: t, ctx: r, cf: e.cf }, async () => {
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.1026846826400134.mjs.map
